...
export default function Header() {
  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-[#AFCFE4]/80 to-white min-h-[76vh] sm:min-h-[88vh] lg:min-h-[100vh] py-12 sm:py-16 px-4 sm:px-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl text-center mt-8 sm:mt-12">
        ...
        {/* Title - Fade in up with delay - Using the tighter line spacing */}
        <h1 
          className="opacity-0 animate-fade-in-up text-4xl sm:text-5xl md:text-7xl font-light text-black font-poppins leading-[1.1] sm:leading-[1]"
        ...
        <p 
          className="opacity-0 animate-fade-in-up max-w-lg mx-auto mt-3 text-base sm:text-lg text-gray-700 leading-relaxed px-2 sm:px-0"
          style={{ animationDelay: "0.8s", animationFillMode: "forwards" }}
        >
          Discover the perfect space for your event or business meeting.
        </p>    
