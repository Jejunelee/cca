...
const venues = [
  {
    id: "alder",
    name: "Alder Function Room",
    description:
      "An intimate and versatile space with warm natural light, ideal for private dinners, board meetings, and creative workshops.",
    images: [
      "/venues/Alder/1.png",
    ],
  },
  {
    id: "acacia",
    name: "Acacia Function Room",
    description:
      "A refined setting featuring elegant finishes and ample space for medium-sized gatherings, from cocktail receptions to seminar-style events.",
    images: [
      "/venues/Acacia/1.png",
    ],
  },
  {
    id: "bamboo",
    name: "Bamboo Function Room",
    description:
      "A serene and sophisticated venue that blends organic textures with modern design, perfect for celebrations and exclusive corporate events.",
    images: [
      "/venues/Bamboo/1.png",
    ],
  },
  {
    ...
    name: "Origine",
    description:
      "A distinguished venue that embodies authentic elegance and refined sophistication, perfect for exclusive galas, milestone celebrations, and high-profile corporate gatherings.",
    images: [
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-5 md:px-8 lg:px-20 py-12 lg:py-16">
          <div className="max-w-xl">
            ...
            <p className="font-jost text-base md:text-lg lg:text-[22px] leading-relaxed text-black mb-6 lg:mb-0">
              Brittany Hotel in Bonifacio Global City offers luxurious
              accommodations with elegant rooms and world-class amenities.
              Perfect for corporate events, intimate gatherings, and special
              celebrations, the hotel provides sophisticated venues with
            ...
            <div className="lg:hidden mt-6">
              <a
                href="https://maps.google.com/?q=Brittany%20Hotel%20BGC"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="font-jost text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
              Distinct venues crafted for memorable moments — from intimate
