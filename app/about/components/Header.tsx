...
export default function Header() {
  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-[#AFCFE4]/80 to-white min-h-[72vh] sm:min-h-[84vh] lg:min-h-[96vh] py-12 sm:py-16 px-4 sm:px-6 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-lg text-center mt-8 sm:mt-12">
        
        {/* Title - Fade in up with delay */}
        <h1 
          className="opacity-0 animate-fade-in-up text-4xl sm:text-5xl md:text-7xl font-light text-black font-poppins leading-tight sm:leading-normal"
        ...
        {/* Description - Fade in up with longer delay - spacing reduced by 50% */}
        <p 
          className="opacity-0 animate-fade-in-up text-base sm:text-lg text-gray-700 leading-relaxed px-2 sm:px-0 max-w-2xl mx-auto mt-3"
